...
class MCTruthToEDM
    : public Gaudi::Functional::MultiTransformer<std::tuple<LHCb::MCParticles, LHCb::MCVertices, LHCb::MCHeader>(
          const Gaussino::MCTruthPtrs& )>
{
public:
  /// Standard constructor.
  MCTruthToEDM( const std::string& name, ISvcLocator* pSvcLocator )
      : MultiTransformer( name, pSvcLocator, {KeyValue{"MCTruthLocation", Gaussino::MCTruthsLocation::Default}},
  ...
  virtual std::tuple<LHCb::MCParticles, LHCb::MCVertices, LHCb::MCHeader>
...
private:
  ...
  {
  public:
    Converter( LHCb::MCParticles& mcparticles, LHCb::MCVertices& mcvertices, MsgStream& stm )
        : msgStream( stm ), m_particles( mcparticles ), m_vertices( mcvertices )
    {
    }
