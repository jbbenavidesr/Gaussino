...
if(USE_ADEPT)
  ...
  add_compile_definitions(USE_ADEPT USE_G4HEPEM)
  set(USE_G4HEPEM ON)  # Since AdePT pulls it in
else()
  find_package(G4HepEm QUIET)
  if(G4HepEm_FOUND)
    message(STATUS "G4HepEm found (no AdePT): enabling support")
