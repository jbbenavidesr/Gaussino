...
public:
   ...
   *                            tree.
   */
  virtual StatusCode generateDecay( const HepMC3::GenParticlePtr& theMother, HepRandomEnginePtr& engine ) const = 0;
   ...
   *                            violation)
   */
  virtual StatusCode generateSignalDecay( const HepMC3::GenParticlePtr& theMother, bool& flip,
   ...
   *                            signal particle).
   */
  virtual StatusCode generateDecayWithLimit( const HepMC3::GenParticlePtr& theMother, const int targetId,
                                             HepRandomEnginePtr& engine ) const = 0;
