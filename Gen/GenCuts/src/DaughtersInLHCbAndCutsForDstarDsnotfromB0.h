#ifndef GENCUTS_DAUGHTERSINLHCBANDCUTSFORDSTARDSNOTFROMB0_H 
#define GENCUTS_DAUGHTERSINLHCBANDCUTSFORDSTARDSNOTFROMB0_H 1
...
/** @class DaughtersInLHCbAndCutsForDstar DaughtersInLHCbAndCutsForDstarDsnotfromB0.h 
 *  
 ...
 *  @date   2012-02-07
 */
class DaughtersInLHCbAndCutsForDstarDsnotfromB0 : public GaudiTool, virtual public IGenCutTool {
public:
  /// Standard constructor
  DaughtersInLHCbAndCutsForDstarDsnotfromB0( const std::string& type, 
                                     const std::string& name,
                                     const IInterface* parent);
  
  virtual ~DaughtersInLHCbAndCutsForDstarDsnotfromB0( ); ///< Destructor
