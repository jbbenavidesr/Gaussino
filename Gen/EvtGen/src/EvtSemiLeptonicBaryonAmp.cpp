...
void EvtSemiLeptonicBaryonAmp::CalcAmp( EvtParticle *,EvtAmp&,
					EvtSemiLeptonicFF *) {
...
void EvtSemiLeptonicBaryonAmp::CalcAmp( EvtParticle *parent,
                                        EvtAmp& amp,
                                        EvtSemiLeptonicFF *FormFactors ,EvtComplex r00, EvtComplex r01, 
                                        EvtComplex r10, EvtComplex r11 ) {
  //leptons
  ...
  if( EvtPDL::getSpinType(parent->getDaug(0)->getId())==EvtSpinType::DIRAC ) {
    ...
    else if( (par_num==LAMB && bar_num==LAMC1P) //Lambda_c(2593) 
