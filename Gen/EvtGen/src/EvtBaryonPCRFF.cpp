...
void EvtBaryonPCRFF::getscalarff( EvtId, EvtId, 
				  double, double, double *, 
				  double *) {
}

void EvtBaryonPCRFF::getvectorff( EvtId, EvtId,  
				  double, double, double *,  
				  double *, double *, double *) {
}

void EvtBaryonPCRFF::gettensorff( EvtId, EvtId,  
				  double, double, double *, 
				  double *, double *, double *) {

}
 
void EvtBaryonPCRFF::getbaryonff(EvtId, EvtId, 
				 double, double, double*, 
				 double*, double*, double*) {
}
