...
#include "CreateBeamParameters.h"

//-----------------------------------------------------------------------------
// Implementation file for class : CreateBeamParameters
//
// 2018-01-29: Dominik Muller
//-----------------------------------------------------------------------------

// Declaration of the Algorithm Factory
DECLARE_COMPONENT( CreateBeamParameters )

StatusCode CreateBeamParameters::initialize()
{
...
LHCb::GenHeader CreateBeamParameters::operator()() const
{
...
StatusCode CreateBeamParameters::finalize()
{
  delete m_barrier;
  delete m_endbarrier;
...
void CreateBeamParameters::printEventRun( long long event, int run, std::vector<long int>* seeds ) const
{
