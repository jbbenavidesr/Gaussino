...
/** @class CreateBeamParameters CreateBeamParameters.h
 *
 ...
 *  @date   2018-01-29
 */
class CreateBeamParameters : public Gaudi::Functional::Producer<LHCb::GenHeader(), Gaudi::Functional::Traits::BaseClass_t<RndInitAlg>>
{
private:
...
public:
  ...
  CreateBeamParameters( const std::string& name, ISvcLocator* pSvcLocator )
