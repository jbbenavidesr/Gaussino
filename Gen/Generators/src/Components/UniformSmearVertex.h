 ...
 *  @date   2007-09-07
 */
class UniformSmearVertex : public GaudiTool, virtual public IVertexSmearingTool {
public:
  /// Standard constructor
  UniformSmearVertex( const std::string& type, const std::string& name, const IInterface* parent );
