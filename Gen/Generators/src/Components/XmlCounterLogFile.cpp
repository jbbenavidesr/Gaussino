...
//=============================================================================
XmlCounterLogFile::XmlCounterLogFile( const std::string& type, const std::string& name, const IInterface* parent )
...
//=============================================================================
void XmlCounterLogFile::addEfficiency( const std::string& name, const unsigned int after, const unsigned int before,
...
//=============================================================================
void XmlCounterLogFile::addFraction( const std::string& name, const unsigned int number, const double fraction,
...
//=============================================================================
void XmlCounterLogFile::addCrossSection( const std::string& name, const unsigned int processId,
                                         const unsigned int number, const double value ) {
...
StatusCode XmlCounterLogFile::initialize() {
  ...
  if ( !m_file.is_open() ) return Error( "Cannot open xml log file" );
