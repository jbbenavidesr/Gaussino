...
protected:
  ...
  StatusCode decayEvent( HepMC::GenEvent* theEvent ) const;
...
private:
  ...
  const interactionCNames m_intCName{{
    "generated interactions with >= 1b",    
    "generated interactions with >= 3b",
    "generated interactions with 1 prompt B",
    "generated interactions with >= 1c",
    "generated interactions with >= 3c",
    "generated interactions with >= prompt C",
    "generated interactions with b and c"}};

  /// Array of accepted counter names
  const interactionCNames m_intCAcceptedName{{
    "accepted interactions with >= 1b",
    "accepted interactions with >= 3b",
    "accepted interactions with 1 prompt B",
    "accepted interactions with >= 1c",
    "accepted interactions with >= 3c",
    "accepted interactions with >= prompt C",
