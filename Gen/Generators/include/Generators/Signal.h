...
public:
  ...
  Signal( const std::string& type, const std::string& name, const IInterface* parent );
...
protected:
   ...
   */
  HepMC3::GenParticlePtr chooseAndRevert( ParticleVector& particleList, bool& isInverted, bool& hasFlipped,
   ...
   */
  void updateCounters( const ParticleVector& particleList, std::atomic_uint& particleCounter,
                       std::atomic_uint& antiparticleCounter, bool onlyForwardParticles, bool isInverted ) const;
...
private:
   ...
   *                              to theNewParticle.
   */
  StatusCode fillHepMCEvent( HepMC3::GenParticlePtr& theNewParticle, const HepMC3::GenParticlePtr& theOldParticle,
                             HepMC3::GenEvent* theEvent ) const;
