...
namespace F77Utils {
   ...
   *  @date   2006-10-03
   */
  StatusCode close( int lun, const bool verbose = false );
  // ==========================================================================
   ...
   *  @date   2006-10-03
   */
  StatusCode openNew( int lun, const std::string& file, const bool verbose = false );
  // ==========================================================================
   ...
   *  @date   2006-10-03
   */
  StatusCode openOld( int lun, const std::string& file, const bool verbose = false );
  // ==========================================================================
   ...
   *  @date   2006-10-03
   */
  StatusCode openUnknown( int lun, const std::string& file, const bool verbose = false );
  // ==========================================================================
  /** Open Fortran file with status="UNKNOWN"
   *  @param lun logical file number
   *  @param file file name
   ...
   *  @date   2006-10-03
   */
  StatusCode open( int lun, const std::string& file, const bool verbose = false );
  // ==========================================================================
  /** @fn openNewFormatted
   ...
   *  @date   2006-10-03
   */
  StatusCode openNewFormatted( int lun, const std::string& file, const bool verbose = false );
  // ==========================================================================
   ...
   *  @date   2006-10-03
   */
  StatusCode openOldFormatted( int lun, const std::string& file, const bool verbose = false );
  // ==========================================================================
   ...
   *  @date   2006-10-03
   */
  StatusCode openUnknownFormatted( int lun, const std::string& file, const bool verbose = false );
  // ==========================================================================
  /** Open "FORMATTED" Fortran file with status="UNKNOWN"
   *  @param lun logical file number
   *  @param file file name
   ...
   *  @date   2006-10-03
   */
  StatusCode openFormatted( int lun, const std::string& file, const bool verbose = false );
  // ==========================================================================
