...
Generation().MinimumBias.CRMCProduction.BoostAndRotate = False #not needed, Boost is done in EPOS and rotation by Vertex tool
Generation().MinimumBias.CRMCProduction.Frame = "target"
