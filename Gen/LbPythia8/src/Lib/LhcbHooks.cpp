...
namespace Pythia8 {
  double LhcbHooks::multiplySigmaBy( const SigmaProcess* sigmaProcessPtr, const PhaseSpace* phaseSpacePtr, bool ) {
    ...
    if ( sigmaProcessPtr->nFinal() == 2 && ( ( code >= 400 && code <= 600 ) || ( code >= 111 && code <= 124 ) ) ) {
