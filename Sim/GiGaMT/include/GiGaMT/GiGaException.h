...
public:
  ...
  */
  ...
  /**    constructor
         ...
         @param sc         status code to be associated with teh exception
  */
  GiGaException( const std::string& message, const GaudiException& Exception,
...
#  define ___GIGA_PRINT_STD_____( _tag, _method, _ms, _ss, _ex )                                                       \
    {                                                                                                                  \
      ...
      _log1 << MSG::ERROR << _str << " : " << endmsg;                                                                  \
      _log2 << MSG::ERROR << "*std::exception* what=" << _ex.what() << endmsg;                                         \
...
#  define ___GIGA_CATCH_ALL_____( _body )                                                                              \
    catch ( ... ) {                                                                                                    \
      _body;                                                                                                           \
    }
