...
static const G4double AgelZEndAnalysis=AgelZBeginAnalysis+52.1*CLHEP::mm;
static const G4double C4F10AllZBeginAnalysis=990.0*CLHEP::mm;
static const G4double C4F10ZBeginAnalysis=AgelZEndAnalysis+2.0*CLHEP::mm;
...
static const G4double Rich1AnalysisXHalfSize = 3.25*CLHEP::m;
static const G4double Rich1AnalysisYHalfSize = 3.80*CLHEP::m;
