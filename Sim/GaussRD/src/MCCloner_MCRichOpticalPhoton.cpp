...
LHCb::MCRichOpticalPhoton* MCCloner::getStoredMCRichOpticalPhoton(const LHCb::MCRichOpticalPhoton* mchit) {
...
LHCb::MCRichOpticalPhoton* MCCloner::cloneKeyedMCRichOpticalPhoton(const LHCb::MCRichOpticalPhoton* mchit) {
    ...
    if (!clone) {
        ...
        m_mcrichops.insert(std::pair<const LHCb::MCRichOpticalPhoton*, LHCb::MCRichOpticalPhoton*>(mchit, clone));
...
LHCb::MCRichOpticalPhoton* MCCloner::cloneMCRichOpticalPhoton(const LHCb::MCRichOpticalPhoton* mchit) {
...
LHCb::MCRichOpticalPhoton* MCCloner::doCloneMCRichOpticalPhoton(const LHCb::MCRichOpticalPhoton* mchit) {
    if (!mchit) return NULL;
