...
class GenerationToSimulation : public GaudiAlgorithm {
  ...
  void convert(HepMC::GenParticle*& particle, G4PrimaryVertex* pvertexg4, LHCb::MCVertex* originVertex, G4PrimaryParticle* motherg4,
  ...
  G4PrimaryParticle* makeG4Particle(HepMC::GenParticle*& particle, LHCb::MCParticle* mcp) const;

  /// Create an MCParticle from a HepMC GenParticle.
  LHCb::MCParticle* makeMCParticle(HepMC::GenParticle*& particle, LHCb::MCVertex*& endVertex) const;

  /// Compute the lifetime of a particle.
  double lifetime(const HepMC::FourVector mom, const HepMC::GenVertex* P, const HepMC::GenVertex* E) const;
  ...
  void removeFromPrimaryVertex(G4PrimaryVertex*& pvertexg4, const G4PrimaryParticle* particleToDelete) const;
