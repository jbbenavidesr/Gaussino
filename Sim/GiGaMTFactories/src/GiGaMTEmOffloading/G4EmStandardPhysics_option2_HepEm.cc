...
//
G4_DECLARE_PHYSCONSTR_FACTORY( G4EmStandardPhysics_option2_HepEm );

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4EmStandardPhysics_option2_HepEm::G4EmStandardPhysics_option2_HepEm( G4int ver, const G4String& )
...
G4EmStandardPhysics_option2_HepEm::~G4EmStandardPhysics_option2_HepEm() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void G4EmStandardPhysics_option2_HepEm::ConstructParticle() {
...
void G4EmStandardPhysics_option2_HepEm::ConstructProcess() {
  ...
  std::cout << " ### G4HepEm is active: using the GiGaG4HepEmTrackingManager for e-/e+ and gamma." << std::endl;

  // Construct the G4HepEm tracking manager and configure:
  GiGaG4HepEmTrackingManager* trackingManager = new GiGaG4HepEmTrackingManager( /*verboseLevel*/ 1 );

  G4HepEmConfig* config = trackingManager->GetConfig();
  config->SetMultipleStepsInMSCWithTransportation( false ); // default was false
