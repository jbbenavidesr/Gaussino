...
GaudiSequencer("Monitor").Members += [ "GaudiSequencer/GenFSRSeq" ]
    
#from PRConfig import TestFileDB
#TestFileDB.test_file_db["genFSR_2012_sim"].run(configurable=Gauss())
...
EventSelector().Input += [
    ...
    #"DATAFILE='/afs/cern.ch/user/d/dfazzini/cmtuser/GaussDev_v48r3/genFSR_2012_Gauss_created.xgen' TYP='POOL_ROOTTREE' OPT='READ'"
    ]

LHCbApp().EvtMax = -1
    
#IOExtension().inputFiles(['PFN:genFSR_2012_Gauss_merged.sim'])
